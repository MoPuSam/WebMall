	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#p"+page).css("background-color","#AAE");
			});                    
		 	/* $(document).ready(function(){
				page=${page};
				pages=${pages};
			...
			/* $(function(){
				 ...
				 var params = {"method":"findHitory"};
				 load(url,params,function(data){
					 $.each($.parseJSON(data),function(i,n){
						 alert(n.pname);
						 $("#history").append("<li style='width: 150px;height: 216;float: left;margin: 0 8px 0 0;padding: 0 18px 15px;text-align: center;'><a href='${pageContext.request.contextPath}/productServlet?method=findByPid&pid="+n.pid+"'><img src='${pageContext.request.contextPath}/"+n.pimage+"' width='130px' height='130px' /></a></li>");
					 });
				 });
			 }); */
		</script>
	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<c:forEach items="${productList}" var="item">
				<div class="col-md-2">
				<a href="${pageContext.request.contextPath}/productServlet?method=findByPid&pid=${item.pid}">
					<img src="${pageContext.request.contextPath}/${item.pimage}" width="170" height="170" style="display: inline-block;">
				</a>
				<p class="pname"><a href="${pageContext.request.contextPath}/productServlet?method=findByPid&pid=${item.pid}" style='color:green'>${item.pname}</a></p>
		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			<ul class="pagination" style="text-align:center; margin-top:10px;">
				<li><a id="up" href="${pageContext.request.contextPath}/productServlet?method=findAll&page=${page-1}&cid=${cid}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
				<%-- <li class="active"><a href="#">1</a></li>
				<li><a href="${pageContext.request.contextPath}/productServlet?method=findAll&page=2&cid=${cid}">2</a></li>
				<li><a href="#">3</a></li>
				<li><a href="#">4</a></li>
				<li><a href="#">5</a></li>
				<li><a href="#">6</a></li>
				...
				<c:forEach items="${pages}" var="i">
					<li><a id="p${i}" href="${pageContext.request.contextPath}/productServlet?method=findAll&page=${i}&cid=${cid}">${i}</a></li>
				</c:forEach> 
				<li>
					<a a id="down" href="${pageContext.request.contextPath}/productServlet?method=findAll&page=${page+1}&cid=${cid}" aria-label="Next">
			...
			<div style="overflow: hidden;">
				...
				<ul id="history" style="list-style: none;">
					<%-- <li style="width: 150px;height: 216;float: left;margin: 0 8px 0 0;padding: 0 18px 15px;text-align: center;"><img src="${pageContext.request.contextPath}/products/1/cs10001.jpg" width="130px" height="130px" /></li> --%>
					 <c:forEach items="${his}" var="pid">
					 <c:if test="${pid!=null}">
						<li style="width: 150px;height: 216;float: left;margin: 0 8px 0 0;padding: 0 18px 15px;text-align: center;">
							<a href="${pageContext.request.contextPath}/productServlet?method=findByPid&pid=${pid.pid}">
								<img src="${pageContext.request.contextPath}/${pid.pimage}" width="130px" height="130px" />
							</a>
						</li>
					</c:if>
					</c:forEach>  
