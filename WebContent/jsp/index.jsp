		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newList}" var="hot">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/productServlet?method=findByPid&pid=${hot.pid}">
							<img src="${pageContext.request.contextPath}/${hot.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/productServlet?method=findByPid&pid=${hot.pid}" style='color:#666'>${hot.pname}</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotList}" var="hot">
						...
						<p><a href="${pageContext.request.contextPath}/productServlet?Method=findById&pid=${hot.pid}" style='color:#666'>${hot.pname}</a></p>
						<p><font color="#E4393C" style="font-size:16px">&yen;${hot.shop_price}</font></p>
					</div>
					</c:forEach>
					<%-- <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
